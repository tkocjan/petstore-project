...
import org.agoncal.application.petstore.service.ICatalogService;
import org.agoncal.application.petstore.service.IPurchaseOrderService;
...
public class ShoppingCartBean extends AbstractBean implements Serializable {
    ...
    public String confirmOrder() {
        order = orderService.createOrder(getCustomer(), creditCard, getCartItems());
        cartItems.clear();
